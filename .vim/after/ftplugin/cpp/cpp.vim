...
if executable("g++") && (&makeprg == "make" || &makeprg == "")
    let &makeprg = "_VIM_CPP_COMPILE_TMP_DIR=$(mktemp -d) && g++ --std c++17 -Wall -o ${_VIM_CPP_COMPILE_TMP_DIR}/%:r % && ${_VIM_CPP_COMPILE_TMP_DIR}/%:r"
endif 
...
if executable('astyle')
    let s:opts = [
                ...
                \ '--mode=c',
                \ '--style=google',
                \ '--indent='.(&expandtab ? 'tab' : 'spaces').'='.max([&shiftwidth, 2]), 
