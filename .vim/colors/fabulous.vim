...
fu! s:hi(item, fg, bg, ...)
    ...
    let l:effects = join(map(deepcopy(a:000), '"cterm=".v:val." gui=".v:val'), ' ')
...
call s:hi('Builtin'     ,  134,   '', 'none')
call s:hi('Character'   ,  190,   '', 'none')
call s:hi('ColorColumn' ,   '', s:bg, 'none')
call s:hi('Comment'     ,   32,  255, 'none')
call s:hi('Conditional' ,  172,   '', 'bold')
call s:hi('Constant'    ,   44,   '', 'italic')
call s:hi('Cursor'      , s:fg,  130, 'none')
call s:hi('CursorLine'  ,   '',  255, 'none')
call s:hi('CursorLineNr',  204, s:bg, 'none')
call s:hi('EndOfBuffer' ,  '',  s:bg, 'none')
call s:hi('DiffAdd'     ,   '',  120, 'none')
call s:hi('DiffChange'  ,   '',  159, 'none')
call s:hi('DiffDelete'  ,  125,  125, 'none')
call s:hi('DiffText'    ,   '',  255, 'none')
call s:hi('Directory'   ,   25,   '', 'none')
call s:hi('FoldColumn'  ,   67, s:bg, 'none')
call s:hi('Function'    ,  130,   '', 'bold')
call s:hi('Include'     ,  160,   '', 'bold')
call s:hi('Keyword'     ,   99,   '', 'bold')
call s:hi('Macro'       ,  135,   '', 'none')
call s:hi('MatchParen'  ,   '',   '', 'inverse')
call s:hi('ModeMsg'     ,   89,   '', 'none')
call s:hi('Number'      ,    3,   '', 'none')
call s:hi('Operator'    ,  246,   '', 'none')
call s:hi('Pmenu'       ,   '',    7, 'none')
call s:hi('PmenuSbar'   ,   '',  244, 'none')
call s:hi('PmenuSel'    ,   '',    8, 'none')
call s:hi('PreProc'     ,  197,   '', 'none')
call s:hi('Repeat'      ,   31,   '', 'bold')
call s:hi('SignColumn'  ,   '', s:bg, 'none')
call s:hi('Special'     ,   56,   '', 'none')
