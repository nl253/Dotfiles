...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ranger golden-ratio)
...
you should place your code here."
  ...
  (spacemacs/set-leader-keys "tg" 'golden-ratio)
