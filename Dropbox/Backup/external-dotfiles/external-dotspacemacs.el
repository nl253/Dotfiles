...
(defun dotspacemacs/layers ()
 ...
 values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ranger)
...
(defun dotspacemacs/user-config ()
 ...
 you should place your code here."
  ...
  (spacemacs/set-leader-keys "ad" 'ranger)
  (spacemacs/set-leader-keys "ak" 'quelpa)
  ...
  (spacemacs/set-leader-keys "3" 'spacemacs/layouts-transient-state/spacemacs/persp-switch-to-3)
  (spacemacs/set-leader-keys "4" 'spacemacs/layouts-transient-state/spacemacs/persp-switch-to-4)
  (spacemacs/set-leader-keys "5" 'spacemacs/layouts-transient-state/spacemacs/persp-switch-to-5)
  (spacemacs/set-leader-keys "6" 'spacemacs/layouts-transient-state/spacemacs/persp-switch-to-6)
  (spacemacs/set-leader-keys "7" 'spacemacs/layouts-transient-state/spacemacs/persp-switch-to-7)
