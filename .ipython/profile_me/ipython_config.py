...
c.InteractiveShellApp.exec_files = [os.path.expanduser('~/.ipythonrc')]
...
c.BaseIPythonApplication.profile = 'me'
...
#c.InteractiveShell.banner1 = "Python 3.5.0 (default, May  1 2017, 12:09:31) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.0.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting:
#  paraiso-dark, algol_nu, arduino, bw, rainbow_dash, lovelace, vs, manni, monokai, tango, paraiso-light, friendly, colorful, vim, fruity, perldoc, rrt, emacs, algol, native, autumn, igor, abap, default, murphy, trac, xcode, borland, pastie
